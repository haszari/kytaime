...
export function throwdown_updateSectionRenderPosition({ deckId, sectionId, time, phraseBeats }) {
  return { type: actionTypes.THROWDOWN_UPDATE_SECTION_RENDER_POSITION, ...{ deckId, sectionId, time, phraseBeats } };
}
