...
fileImport.importThrowdownFileToDeck(
   "data/20191125--janura-crossing.hjson",
   "deck"
);
...
store.dispatch( transportActions.setTempo( initialTempo ) );
store.dispatch( transportActions.setNextTempo( initialTempo ) );
